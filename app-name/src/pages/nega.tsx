...
const InstagramStory = ({ imageUrl, content }) => (
  <motion.div
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <section className="mb-20">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="w-full md:w-1/2 mb-8 md:mb-0">
                <motion.h1 
                  className="text-3xl md:text-5xl font-bold text-[#78AAC3] mb-6"
        ...
        <FadeInSection delay={0.8}>
          <section className="mb-20" id="mindful">
            <motion.div 
              className="bg-[#C4DDF5] rounded-lg p-8 flex flex-col md:flex-row items-center justify-between"
