          ...
          <nav className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex items-center space-x-6">
              <li className="transition-transform duration-300 ease-in-out hover:scale-110 active:scale-90">
                <Link href="/" className="text-gray-600 hover:text-[#78AAC3] transition-colors">Mindful</Link>
              </li>
              <li className="transition-transform duration-300 ease-in-out hover:scale-110 active:scale-90">
                <Link href="/servicios" className="text-gray-600 hover:text-[#78AAC3] transition-colors">Servicios</Link>
              </li>
              <li className="transition-transform duration-300 ease-in-out hover:scale-110 active:scale-90">
                <Link href="/talleres" className="text-gray-600 hover:text-[#78AAC3] transition-colors">Talleres</Link>
              </li>
            ...
            <Sheet>
              ...
              <SheetContent>
                <nav className="flex flex-col space-y-4 mt-6">
                  <Link href="/" className="text-lg font-medium hover:text-[#78AAC3] transition-colors">Mindful</Link>
                  <Link href="/servicios" className="text-lg font-medium hover:text-[#78AAC3] transition-colors">Servicios</Link>
                  <Link href="/talleres" className="text-lg font-medium hover:text-[#78AAC3] transition-colors">Talleres</Link>
