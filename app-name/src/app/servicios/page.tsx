...
import { Menu, ChevronRight, Brain, TrendingUp, Calendar, Smile, Users, Book, Phone, CheckCircle } from 'lucide-react'
  ...
  return (
    <div className="bg-gradient-to-b from-[#C4DDF5] to-white min-h-screen">
          ...
          <nav className="flex justify-between items-center py-4">
            ...
            <ul className="hidden md:flex items-center space-x-6">
              <li className="transition-transform duration-300 ease-in-out hover:scale-110 active:scale-90">
                <a href="/" className="text-gray-600 hover:text-[#78AAC3] transition-colors">Mindful</a>
              </li>
              <li className="transition-transform duration-300 ease-in-out hover:scale-110 active:scale-90">
            ...
            <Sheet>
              ...
              <SheetContent>
                <nav className="flex flex-col space-y-4 mt-6">
                  <a href="/" className="text-lg font-medium hover:text-[#78AAC3] transition-colors">Mindful</a>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <section className="mb-20" id="servicios">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="transition-all duration-300 ease-in-out hover:-translate-y-2">
                <Card className="flex flex-col h-full">
                  <CardHeader>
                    <h3 className="text-xl font-semibold text-center">Terapia presencial y Online</h3>
                  </CardHeader>
                  <CardContent className="flex-grow">
                    <p className="text-3xl font-bold text-center text-[#78AAC3] mb-4">$30</p>
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        <CheckCircle className="w-5 h-5 mr-2 text-[#97C8D8]" />
                        <span>Sesiones individuales</span>
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="w-5 h-5 mr-2 text-[#97C8D8]" />
                        <span>Opción presencial o en línea</span>
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="w-5 h-5 mr-2 text-[#97C8D8]" />
                        <span>Flexibilidad para tus necesidades</span>
                      </li>
                    </ul>
                  </CardContent>
                  <CardFooter>
                    <Button className="w-full bg-[#97C8D8] hover:bg-[#78AAC3] text-white" onClick={handleAppointmentClick}>
                      Reservar sesión
                    </Button>
                  </CardFooter>
                </Card>
        ...
        {/* About Me section and CTA can be added here if needed */}
        
      </main>

      <footer className="bg-[#78AAC3] text-white py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-8 md:mb-0 text-center md:text-left">
              <h3 className="text-2xl font-semibold mb-2">Trabajando tu mente</h3>
              <p className="text-sm">Transformando vidas, una sesión a la vez.</p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/10 text-center text-sm">
            <p>&copy; 2023 Trabajando tu mente. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
